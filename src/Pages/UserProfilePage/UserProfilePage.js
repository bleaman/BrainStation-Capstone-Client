			...
			<div className="user-profile-page__info-container">
				<div className="user-profile-page__top-box">
					...
					<div className="user-profile-page__top-box-right">
						...
						<Animated animationIn="zoomInRight" animationInDuration={1750} animationOut="zoomOutDown" animationOutDuration={500} isVisible={true}>
							<div className="user-profile-page__top-box-right-text">{userData.email}</div>
						</Animated>
						<Animated animationIn="zoomInLeft" animationInDuration={1750} animationOut="zoomOutDown" animationOutDuration={500} isVisible={true}>
				...
				<div className="user-profile-page__bottom-box">
					...
					<div className="user-profile-page__bottom-box-right">
						{businessList.map((business) => {
							return (
								<Animated key={business.id} animationIn="zoomInRight" animationInDuration={2250} animationOut="zoomOutDown" animationOutDuration={500} isVisible={true}>
