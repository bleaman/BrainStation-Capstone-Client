							...
							<div className="create-business__form-value">
								<form onSubmit={handleSubmit}>
									...
									<div className="create-business__inputbox animate__animated animate__lightSpeedInRight">
										<input className="create-business__input" minLength="1" maxLength="50" type="text" name="bizname" value={businessName} onChange={(event) => setBusinessName(event.target.value)} required />
									...
									<div className="create-business__inputbox animate__animated animate__lightSpeedInLeft">
										<input className="create-business__input" minLength="1" maxLength="500" type="text" name="bizdescription" value={businessDescription} onChange={(event) => setBusinessDescription(event.target.value)} required />
										<label className="create-business__label">Description</label>
									</div>
									<div className="create-business__inputbox animate__animated animate__lightSpeedInRight">
										<input className="create-business__input" minLength="1" maxLength="250" type="text" name="bizlocation" value={businessLocation} onChange={(event) => setBusinessLocation(event.target.value)} required />
